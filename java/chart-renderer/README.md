...
| --- | --- | --- |
| Small failed segment | `--passed 31 --failed 1 --title "Regress feature"` | <img src="docs/examples/regress-feature-small-failed.png" alt="Regress feature chart" width="320"> |
